							  ...
							  isLoading ? (
								<div className="chat chat-start" key={key}>
									...
									>
										<div className="flex items-center justify-center space-x-3">
											<div className="mt-2 h-2 w-2 bg-green-100 rounded-full animate-bounce200"></div>
											<div className="mt-2 h-2 w-2 bg-green-100 rounded-full animate-bounce400"></div>
											<div className="mt-2 h-2 w-2 bg-green-100 rounded-full animate-bounce"></div>
										</div>
									</div>
								</div>
							) : (
								<div className="chat chat-start" key={key}>
									...
									<div
										className={
											"chat-bubble " +
											(message.sender == "bot-s"
												? " chat-bubble-success"
												: " chat-bubble-primary")
										}
									>
										{message.sender === "bot-s" ? (
											<div className="mb-1 text-base font-bold items-center flex">
												<svg
													xmlns="http://www.w3.org/2000/svg"
													fill="none"
													viewBox="0 0 24 24"
